...
if (isset($_POST['ajouter'])) {
  ...
  if (is_numeric($_POST['nom_fournisseur'])) {
    ...
    //Insertion_Bd
    $requete = "INSERT INTO fournisseurs(nom, email, phone, mdp)
      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="users-infos">
          ...
          <div class="address-box">
            <span class="infos">mos de passe</span>
            <input type="number" placeholder="Adresse du fournisseur" name="adr_fournisseur">
          </div>
