...
//Rappel : votre serveur = localhost | votre login = root | votre mot de pass = '' (rien)
    ...
    if ($db_found) {
        if (isset($_GET['id_client'])) {
            ...
            $sql2 = "INSERT INTO commande ( id_produit, id_client,etat_cmd) VALUES ( " . $_GET['id_produit'] . ", " . $_GET['id_client'] . ",'en cours de traitement')";
...
<body>
    ...
    <footer>
        <small>
            ...
            <p align="center">tel : +33(0)652811128 </p>
            </p>
