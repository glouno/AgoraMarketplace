...
//Rappel : votre serveur = localhost | votre login = root | votre mot de pass = '' (rien)
        ...
        if ($db_found) {
            if ($_GET['type'] == 0) {
                ...
                $sql = "SELECT * FROM produits WHERE type_prix=  'Article rare' ORDER BY prix asc";
            } elseif ($_GET['type'] == 2) {
                $sql = "SELECT * FROM produits WHERE type_prix=  'Article haut de gamm' ORDER BY prix asc";
            } elseif ($_GET['type'] == 3) {
                $sql = "SELECT * FROM produits WHERE type_prix=  'Article régulier' ORDER BY prix asc";
            } else {
