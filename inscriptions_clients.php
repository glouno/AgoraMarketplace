      ...
      <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
        ...
        <div class="users-infos">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Votre nom d'utilisateur" name="nom_utilisateur_clt" id="nom_utilisateur_clt"
              required>
          </div>
          ...
          <div class="input-box">
            ...
            <input type="password" placeholder="Au moins 6 caracteres" name="mdp_clt" id="mdp_clt" required
              minlength="6">
          </div>
          <div class="input-box">
            <span class="infos">Confirmation du mot de passe</span>
            <input type="password" placeholder="Confirmez votre mot de passe" name="mdp_conf_clt" id="mdp_conf_clt"
        ...
        <div class="users-infos">
          ...
          <div class="input-box">
            ...
            <input type="month" placeholder="Date d’expiration de la carte" name="dt_exp_carte" id="dt_exp_carte"
              required min="2023-05" max="2028-12">
          </div>

          <div class="input-box">
            <span class="infos">Code de sécurité</span>
            <input type="text" placeholder="Code de sécurité" name="code_sec_clt" id="code_sec_clt" required min
              length=3 maxlength="4">
          </div>
